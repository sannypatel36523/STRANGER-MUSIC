...
# Bot and owner info
OWNER_USERNAME = getenv("OWNER_USERNAME", "TeaMan7D5")
BOT_USERNAME = getenv("BOT_USERNAME", "Test1XYZBot")
...
LOGGER_ID = int(getenv("LOGGER_ID", -2899331069))
OWNER_ID = int(getenv("OWNER_ID", 7824703343))
...
# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/KALYUG_NET")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/KL_chatGroup")
